    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ts1_tgs', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), blank=True, default=list, size=None, verbose_name='TS1 TGs')),
                ('ts2_tgs', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), blank=True, default=list, size=None, verbose_name='TS2 TGs')),
                ('ts_configuration', wagtail.core.fields.RichTextField(blank=True, verbose_name='TS config.')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', wagtail.core.fields.RichTextField(blank=True, verbose_name='notes')),
